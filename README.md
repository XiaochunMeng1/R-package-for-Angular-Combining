# R Package for Angular_Combining
...
## 2.3 Estimate_angular_combining.R
...
## 2.4 Estimate_angular_weights.R
...
## 2.5 Estimate_secondary_combining.R
...
## 2.6 Estimate_targeting_variance.R
...
random sample of size n for angular combining.
